...
namespace Plugins.com_bricksandmortarstudio.Crm
{
    ...
    [CodeEditorField( "Family Lava Template", "The lava template to use to display content for a family member", CodeEditorMode.Lava, CodeEditorTheme.Rock, 400, true, @"{% for definedValue in DefinedValues %}
    {{ definedValue.Value }}
{% endfor %}", "", 4, key:"FamilyLava" )]
    [CodeEditorField( "Person Lava Template", "The lava template to use to display content for a person", CodeEditorMode.Lava, CodeEditorTheme.Rock, 400, true, @"{% for definedValue in DefinedValues %}
    {{ definedValue.Value }}
